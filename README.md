...
1️ Firebase Firestore para registrar estudiantes con sus calificaciones, y
2️ API Node.js + Express para enviar y almacenar datos de usuarios desde la app móvil a un servidor local.
